...
public class TestEleveDAO {
	...
	public void testDbSelectFromId() {
		EleveDAO obj = dbInsertNewValidObj();
		EleveDAO obj2 = EleveDAO.dbSelectFromId(obj.getId());
	...
	public void testDbExistFromId() {
		...
		assertFalse("id inexistant doit renvoyer false", EleveDAO.dbExistFromId(-1));
		
		//id existant doit renvoyer true
		EleveDAO obj = dbInsertNewValidObj();
		assertTrue("id existant doit renvoyer true", EleveDAO.dbExistFromId(obj.getId()));
	}
	...
	public void testDbUpdate() {
		...
		EleveDAO obj3 = EleveDAO.dbSelectFromId(obj2.getId());
